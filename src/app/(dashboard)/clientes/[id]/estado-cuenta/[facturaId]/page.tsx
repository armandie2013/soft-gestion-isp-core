    ...
    <PageShell maxWidth="lg">
      ...
      >
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          <Badge variant="info">{formatMoney(detalle.periodo.saldoPeriodo)}</Badge>
        </div>
      </PageHeader>
            ...
            return (
              ...
              >
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className={`flex shrink-0 items-center justify-between gap-3 rounded-xl bg-[var(--app-surface-soft)] px-3 py-2 sm:min-w-40 ${impacto.className}`}>
