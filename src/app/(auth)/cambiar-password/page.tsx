              ...
              <div>
                ...
                <div className="mt-5 space-y-3">
                  <h2 className="max-w-2xl text-[2.55rem] font-semibold leading-[1.05] tracking-tight text-slate-950 dark:text-white">
                    Actualizá tu contraseña personal.
                  </h2>

                  <p className="max-w-xl text-sm leading-6 text-slate-600 dark:text-slate-300">
                    Por seguridad, cuando se utiliza una contraseña temporal o
                    se solicita un cambio, el sistema requiere crear una nueva
                    clave personal antes de continuar.
                  </p>
                </div>
              </div>
              ...
              <div>
                <div className="mb-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-400">
                    Hola, {user.nombre}. Ingresá una nueva contraseña para
                    continuar.
                  </p>
                </div>
