      ...
      <div className="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-6xl flex-col">
        ...
        <section className="grid flex-1 items-center gap-8 py-8 lg:grid-cols-[1fr_0.9fr] lg:py-12">
          <div className="hidden space-y-5 lg:block">
            <div className="inline-flex rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-medium text-amber-800 dark:border-amber-900/70 dark:bg-amber-950/50 dark:text-amber-200">
              Seguridad
            </div>
            ...
            <p className="max-w-xl text-base leading-7 text-slate-600 dark:text-slate-300">
              Por seguridad, cuando un administrador resetea tu clave, el sistema
              te solicita crear una nueva contraseña personal.
            </p>
          </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white/85 p-5 shadow-2xl shadow-slate-950/5 backdrop-blur dark:border-slate-800 dark:bg-slate-950/75 dark:shadow-cyan-950/10 sm:p-6">
              <div className="mb-6 space-y-2">
                ...
                <p className="text-sm leading-6 text-slate-600 dark:text-slate-400">
                  Hola, {user.nombre}. Ingresá una nueva contraseña para continuar.
                </p>
              </div>
