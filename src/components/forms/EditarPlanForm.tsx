...
//       type="submit"
//       disabled={pending}
//       className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-cyan-600 px-4 text-sm font-medium text-white shadow-lg shadow-cyan-950/10 transition hover:bg-cyan-700 disabled:cursor-not-allowed disabled:opacity-70 active:scale-[0.99] dark:bg-cyan-500 dark:text-cyan-950 dark:hover:bg-cyan-400 sm:h-10 sm:w-auto sm:min-w-[190px] sm:text-xs"
//     >
//       {pending ? (
//         <>
...
//             <SelectField id="tipo" name="tipo" defaultValue={plan.tipo}>
//               <option value="residencial">Residencial</option>
//               <option value="comercial">Comercial</option>
//               <option value="corporativo">Corporativo</option>
//               <option value="dedicado">Dedicado</option>
...
//             <SelectField id="estado" name="estado" defaultValue={plan.estado}>
//               <option value="activo">Activo</option>
//               <option value="inactivo">Inactivo</option>
//             </SelectField>
//           </div>
  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      <FormSection
        ...
        eyebrow="Plan"
        title="Datos principales"
        description="Modificá el nombre comercial, tipo y detalle del servicio."
      >
        <div className="grid gap-3 md:grid-cols-2">
          <div>
            <FieldLabel htmlFor="nombre">Nombre</FieldLabel>
      ...
      <FormSection
        ...
        eyebrow="Facturación"
        title="Importe y estado"
        description="Actualizá el valor mensual y la disponibilidad del plan."
      >
        <div className="grid gap-3 md:grid-cols-2">
          <div>
            <FieldLabel htmlFor="importe">Importe</FieldLabel>
