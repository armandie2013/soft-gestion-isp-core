...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <button
        type="button"
        className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 shadow-sm dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300"
        aria-label="Cargando tema"
      >
        <span className="h-4 w-4 rounded-full bg-slate-300 dark:bg-slate-700" />
      </button>
